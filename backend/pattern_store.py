...
__all__ = [
    "PATTERN_KINDS", "OBSERVABLE_STATUSES", "build_events",
...
def idempotency_key(environment: str, symbol: str, timeframe: str,
                    kind: str, status: str, close_t: datetime) -> str:
    """
...
def build_events(symbol: str, timeframe: str, close_t: datetime,
    ...
    for p in patterns or []:
        ...
        out.append({
            ...
            "detail": _detail(p),
            "idempotency_key": idempotency_key(env, sym, timeframe, kind,
                                               status, close_t),
        })
    return out
